...
namespace Stencil.Plugins.MasterCard.Integration
{
    public class Json
    {
        ...
        public static String BuildJsonFromModel(object payment)
        {
            return JsonConvert.SerializeObject(payment);

            // JavaScriptSerializer serializer = new JavaScriptSerializer();
          //  Newtonsoft.Json.JsonSerializer seraializer = new Newtonsoft.Json.JsonSerializer();
            
            // return serialized JSON result
            //return serializer.Serialize((object)payment);
        }
